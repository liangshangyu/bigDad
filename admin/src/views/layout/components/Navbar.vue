    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
          <img class="user-avatar" src="@/assets/images/home.png">
...
import nxTopLock from '@/components/top-lock'
import Breadcrumb from '@/components/breadcrumb'
import nxHamburger from '@/components/hamburger'
import nxHelp from '@/components/help/index'
import nxFullScreen from '@/components/full-screen/index'
import nxLangSelect from '@/components/lang-select/index'
import nxSkin from '@/components/skin/index'
